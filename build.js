...
var result = ugly.minify([cmkitjs, egretjs], { output: { beautify: true, keep_quoted_props: true }, compress: false });
writeResult('egret/cmkit.js', result);
var result = ugly.minify([cmkitjs, egretjs], { mangle: true, compress: true });
