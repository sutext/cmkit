...
declare namespace cm {
     ...
     * @param progress 加载进度
     */
    const loaddir: <T extends cc.Asset>(type: IMetaAsset<T>, dir: string, progress?: IProgress) => Promise<{
        assets: T[];
        urls: string[];
    }>;
    /**
...
declare namespace cm {
    ...
    class Stack extends cc.Component {
        ...
        public readonly push: (name: string, finish?: () => void) => void
        /**
