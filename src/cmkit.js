...
(function (ns) {
            ...
            this.objtask = function (meta, path, data, opts) {
                ...
                var promiss = values[0]
                    .then(function (json) {
                        var parser = options && options.parser || _this.resolve.bind(_this);
                        return parser(json);
                    }).then(function (value) { return new meta(value); });
                return new Network.DataTask(promiss, values[1]);
            };
    ...
    (function (Network) {
        ...
        Network.get = function (url, data, opts) {
            ...
            var promiss = new Promise(function (resolve, reject) {
                ...
                handler = xhr;
                xhr.onabort = function () { return reject(Network.Error.abort(xhr.status)); };
                xhr.ontimeout = function () { return reject(Network.Error.timeout(xhr.status)); };
                xhr.onerror = function () { return reject(Network.Error.service(xhr.status)); };
    ...
    ns.Socket = (function () {
        function Socket(builder, protocols) {
            ...
            this.open = function () {
                if (_this.readyState === Socket.CONNECTING ||
        ...
        Object.defineProperty(Socket.prototype, "protocol", {
            get: function () { return this.ws && this.ws.protocol; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(Socket.prototype, "extensions", {
            get: function () { return this.ws && this.ws.extensions; },
            enumerable: true,
            configurable: true
        });
        ...
        Object.defineProperty(Socket.prototype, "bufferedAmount", {
            get: function () { return this.ws && this.ws.bufferedAmount; },
            enumerable: true,
            configurable: true
        });
        return Socket;
    ...
    (function (Socket) {
        ...
        var Client = /** @class */ (function () {
            function Client() {
                ...
                this.stop = function () {
                    if (_this.socket.readyState === Socket.CLOSED ||
